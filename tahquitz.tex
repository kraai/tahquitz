...
Another good example of this phenomenon are two obscure climbs on the inconveniently located
...
\climb{Northeast Farce}{5.6}

\topo{0.35}{northeast_farce}

This climb may owe its unpopularity to the lack of appropriate pro on P3.
Back in the 1950s, this climb was considered to be two YDS grades harder than
White Maiden's Walkway. That seems about right to me, and that would make
it about 5.6 in modern grades. The Vogel-Gaines guidebook
gives a historical 5.3 rating that is extremely sandbagged by
today's standards. The route is located on the extreme left corner of the northeast
...
The Vogel-Gaines guidebook appears to show the rightward traverse on this pitch at
a location lower down, which would lead to a jagged fissure in the huge flake. They also show another bolt,
which would probably be helpful in protecting a traverse at that location, but which
I and another party both looked for and couldn't find. Doing the traverse lower down
would cut out the harder climbing higher up in the dihedral, but if this is really
what they have in mind, then the ledge shown on their topo would have to be not a real
ledge but one of the barely visible ripples lower down on the slab.
...
\warn{This description is based on only having done the climb twice, and
I haven't done the right-hand variation at the end.
This is raw and probably inaccurate
in many places.}
...
\pitch{1} Head straight up the gully. At one point, progress is blocked
...
\pitch{3} Head for a left-facing dihedral to the right.
...
\pitch{4} Continue up the dihedral to a big ledge near two big, distinctive
...
which can be protected with a small cam, or possibly lower down with a single bouldering
move around a bulge. Climb to a pine tree nestled in an alcove containing a cave.

\pitch{6} Escape the alcove by climbing up and left, then do a long (50 m?), nearly
