...
\warn{This description is based on only having done the climb once.
We may not have been on route, and this is raw and probably inaccurate
in many places.}
...
\pitch{1} Either head straight up or detour left to an arete that overhangs
...
\pitch{2} If the rope didn't reach all the way to the truncated tree,
do another short pitch to reach it. 5.0

\pitch{3} As the gully starts to dissipate, continue up 5.5 and then easy
5th class terrain.

\pitch{4} Head for a left-facing dihedral to the right. Avoid an overhang
...
is about 5.8. The description below is of an route heading off to the left, which
Vogel labels 5.7 but to me seemed more like easy 5th with one 5.6 move.

\pitch{5} Move up and left through easy 5th class, blocky terrain, heading for
a tree nestled against a right-facing dihedral. Only one 5.6 move is required in
order to insert into the dihedral.

\pitch{6} Traverse left. The easiest terrain is found by resisting the temptation
to climb upwards.
